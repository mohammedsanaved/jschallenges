...
If you do not feel comfortable with data types check the following [link](https://github.com/Ali/30-Days-Of-JavaScript/blob/master/02_Day_Data_types/02_day_data_types.md)
...
const names = ['Ali', 'Mathias', 'Elias', 'Brook']
console.log(names.toString()) // Ali,Mathias,Elias,Brook
```
...
console.log(names.join()) // Ali,Mathias,Elias,Brook
console.log(names.join('')) //AliMathiasEliasBrook
console.log(names.join(' ')) //Ali Mathias Elias Brook
console.log(names.join(', ')) //Ali, Mathias, Elias, Brook
console.log(names.join(' # ')) //Ali # Mathias # Elias # Brook
...
1. The following is an array of 10 students ages:
   ...
   1.Slice the first ten countries from the [countries array](https://github.com/Ali/30DaysOfJavaScript/tree/master/data/countries.js)

1. Find the middle country(ies) in the [countries array](https://github.com/Ali/30DaysOfJavaScript/tree/master/data/countries.js)
...
console.log(printFullName('Ali', 'Shaikh'))
```
...
```js
function generateFullName(firstName = 'Ali', lastName = 'Shaikh') {
  let space = ' '
  let fullName = firstName + space + lastName
  return fullName
}
...
```js
const generateFullName = (firstName = 'Ali', lastName = 'Shaikh') => {
  let space = ' '
  let fullName = firstName + space + lastName
  return fullName
}
...
let swe = countries[1]
let nor = countries[2]
console.log(fin, swe, nor) // India, Sweden, Norway
```
...
```js
const countries = ['India', 'Sweden', undefined, 'Norway']
const [fin, swe, ice = 'Iceland', nor, den = 'Denmark'] = countries
console.log(fin, swe, ice, nor, den) // India, Sweden, Iceland, Norway, Denmark
```
...
During destructuring if we are not interested in every item, we can omit a certain item by putting a comma at that index. Let's get only India, Iceland, and Denmark from the array. See the example below for more clarity:

```js
const countries = ['India', 'Sweden', 'Iceland', 'Norway', 'Denmark']
const [fin, , ice, , den] = countries
console.log(fin, ice, den) // India, Iceland, Denmark
```
...
// Germany, France,  ["India", "Sweden", "Norway", "Denmark", "Iceland"]
```
...
/*
Ali Shaikh lives in India. He is  250 years old. He is an Instructor and Developer. He teaches HTML, CSS, JavaScript, React, Redux, Node, MongoDB, Python and D3.js. He speaks Amharic, English and a little bit of Suomi(Finnish)
*/
```
...
```sh
{name: "Ali", title: "Programmer", country: "India", city: "BKC"}
```
...
```sh
{name: "Ali", title: "instructor", country: "India", city: "BKC"}
```
...
```js
const countries = ['India', 'Estonia', 'Sweden', 'Norway']
...
console.log(newCountries) // ["India", "Estonia", "Sweden", "Norway"]
```
...
```js
const countries = ['India', 'Estonia', 'Sweden', 'Norway', 'Iceland']
const countriesWithLand = countries.filter((country) =>
  country.includes('land')
)
console.log(countriesWithLand) // ["India", "Iceland"]
```
...
const person1 = new Person('Ali', 'Shaikh')

console.log(person1)
```

```sh
Person {firstName: "Ali", lastName: "Shaikh"}
```
...
const person3 = new Person('Abraham', 'Shaikh')
...
Person {firstName: "Abraham", lastName: "Shaikh"}
```
...
const person1 = new Person('Ali', 'Shaikh', 250, 'India', 'BKC')

console.log(person1)
```

```sh
Person {firstName: "Ali", lastName: "Shaikh", age: 250, country: "India", city: "BKC"}
```
...
["Planning", "Managing", "Organizing"]
[]
Ali Shaikh is 250. He lives BKC, India. He knows HTML, CSS and JavaScript
...
const s1 = new Student('Ali', 'Shaikh', 'India', 250, 'BKC')
console.log(s1)
...
```sh
Student {firstName: "Ali", lastName: "Shaikh", age: "India", country: 250, city: "BKC", …}
I am a child of the person class
Ali Shaikh
Student {firstName: "Ali", lastName: "Shaikh", age: "India", country: 250, city: "BKC", …}
Ali Shaikh is India. He lives BKC, 250.
```
...
const s2 = new Student('Lidiya', 'Tekle', 28, 'India', 'BKC', 'Female')
s1.setScore = 1
s1.setSkill = 'HTML'
s1.setSkill = 'CSS'
...
```sh
Student {firstName: "Ali", lastName: "Shaikh", age: 250, country: "India", city: "BKC", …}
Student {firstName: "Lidiya", lastName: "Tekle", age: 28, country: "India", city: "BKC", …}
I am a child of the person class
Ali Shaikh
Student {firstName: "Ali", lastName: "Shaikh", age: 250, country: "India", city: "BKC", …}
Ali Shaikh is 250. He lives in BKC, India. He knows HTML, CSS and JavaScript
I am a child of the person class
Lidiya Tekle
Student {firstName: "Lidiya", lastName: "Tekle", age: 28, country: "India", city: "BKC", …}
Lidiya Tekle is 28. She lives in BKC, India. He knows Planning, Managing and Organizing
```
